...
> **Performance Note:** Since occupied minecarts check for signs every game tick, there might be a performance issue(I do not quite sure about this).
...
> **性能提示：** 由于载客矿车每游戏刻都会检查告示牌，可能存在一定的性能损失（我不是很确定影响多大）。
